                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form class="form-sample" method="POST" action="<?php echo site_url('admin/training_curriculum/create/' . $training_id); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <a href="<?php echo site_url('admin/training_curriculum/' . $training_id); ?>" class="btn btn-light">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
