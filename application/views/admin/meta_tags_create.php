                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" method="POST" action="<?php echo site_url('admin/meta_tags_data/store'); ?>" enctype="multipart/form-data">
                                        <p class="card-description">Meta Tags create</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="page_name" value="<?php echo set_value('page_name'); ?>" required>
